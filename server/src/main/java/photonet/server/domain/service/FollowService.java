...
public class FollowService {
  ...
  public boolean isFollowedByLoggedUser(String userName) {
    return followRepository.existsByAuthorUserNameAndTargetUserName(SecurityUtils.loggedUserName(),
        userName);
  }
  ...
  public void unfollow(String followedUser) {
    if (isFollowedByLoggedUser(followedUser)) {
      var follow = followRepository.findByAuthorUserNameAndTargetUserName(
          SecurityUtils.loggedUserName(), followedUser);
